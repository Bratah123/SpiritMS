...
public class LoginCrypto {
    ...
    public static String hexBcrypt(final String in) {
        return hashWithDigest(in, "bcrypt");
    }

    public static String makeSaltedBcryptHash(final String password, final String salt) {
        return hexBcrypt(password + salt);
    }

    public static boolean checkBcryptHash(final String hash, final String password){
        return hash.equals(hexBcrypt(password));
    }

    public static boolean checkSaltedBcrpytHash(final String hash, final String password, final String salt) {
        return hash.equals(makeSaltedBcryptHash(password, salt));
    }
