...
public enum QuickMove {
    ...
    public enum QuickMoveNPC {
        ...
        WORLD_TRANSPORT(0x8, 5, true, 9270035, 0, "Fast travel to other towns and access important NPCs."), //Boats, Airplanes
        ISLAND_TRANSPORT(0x10, 6, true, 1012000, 0, "Take the #cTaxi# to move to major areas quickly."), //Taxi, Camel
