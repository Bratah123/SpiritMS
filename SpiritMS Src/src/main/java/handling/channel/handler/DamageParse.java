...
////                        final MapleMonster source = player.getMap().getMonsterByOid(ap.objectid); // getting the monster
////                        final MonsterStatusEffect check = source.getBuff(MonsterStatus.POISON); // check if the monster has the Poison Debuff;
...
////                            List<MapleMapObject> objs = player.getMap().getMapObjectsInRange(player.getPosition(), 500000, Arrays.asList(MapleMapObjectType.MONSTER));
////                            // Gets a list of Monsters in the map
